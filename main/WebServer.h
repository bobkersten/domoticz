...
private:
	...
	void Cmd_AddScreen(WebEmSession & session, const request& req, Json::Value &root);
	void Cmd_UpdateScreen(WebEmSession & session, const request& req, Json::Value &root);
	void Cmd_DeleteScreen(WebEmSession & session, const request& req, Json::Value &root);
	void Cmd_SetActiveScreen(WebEmSession & session, const request& req, Json::Value &root);
	void Cmd_SetScreenRange(WebEmSession & session, const request& req, Json::Value &root);
	void Cmd_AddChart(WebEmSession & session, const request& req, Json::Value &root);
	void Cmd_UpdateChart(WebEmSession & session, const request& req, Json::Value &root);
	void Cmd_DeleteChart(WebEmSession & session, const request& req, Json::Value &root);
	void Cmd_ChangeChartOrder(WebEmSession & session, const request& req, Json::Value &root);
	void Cmd_AddSerie(WebEmSession & session, const request& req, Json::Value &root);
	void Cmd_UpdateSerie(WebEmSession & session, const request& req, Json::Value &root);
	void Cmd_DeleteSerie(WebEmSession & session, const request& req, Json::Value &root);
	void Cmd_ChangeSerieOrder(WebEmSession & session, const request& req, Json::Value &root);
	...
	void RType_Screens(WebEmSession & session, const request& req, Json::Value &root);
	void RType_Charts(WebEmSession & session, const request& req, Json::Value &root);
	void RType_Series(WebEmSession & session, const request& req, Json::Value &root);
